...
@DatabaseTable(tableName = "GameBhooztIndexcoin")
public class GameBhooztIndexcoin {
    ...
    public GameBhooztIndexcoin() {
    }

    public GameBhooztIndexcoin(int id, int gamecoinindex) {
        this.id = id;
